...
func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "Echo"
	handlerType := (*multi_echo.Echo)(nil)
...
func BuildEchoService(handler multi_echo.Echo) kitex.Service {
...
func echoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(multi_echo.Request)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(multi_echo.Echo).Echo(ctx, req)
		if err != nil {
			return err
		}
	...
	case *EchoArgs:
		success, err := handler.(multi_echo.Echo).Echo(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *kClient) Echo(ctx context.Context, Req *multi_echo.Request) (r *multi_echo.Response, err error) {
	var _args EchoArgs
	_args.Req = Req
