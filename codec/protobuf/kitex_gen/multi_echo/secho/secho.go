...
func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "SEcho"
	handlerType := (*multi_echo.SEcho)(nil)
...
func BuildSEchoService(handler multi_echo.SEcho) kitex.Service {
...
func echoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	return handler.(multi_echo.SEcho).Echo(stream)
}
...
func (x *sEchoechoClient) Send(m *multi_echo.Request) error {
	return x.Stream.SendMsg(m)
}
func (x *sEchoechoClient) Recv() (*multi_echo.Response, error) {
	m := new(multi_echo.Response)
...
func (x *sEchoechoServer) Send(m *multi_echo.Response) error {
	return x.Stream.SendMsg(m)
}

func (x *sEchoechoServer) Recv() (*multi_echo.Request, error) {
	m := new(multi_echo.Request)
	return m, x.Stream.RecvMsg(m)
}
...
var EchoArgs_Req_DEFAULT *multi_echo.Request

func (p *EchoArgs) GetReq() *multi_echo.Request {
	if !p.IsSetReq() {
...
type EchoResult struct {
	Success *multi_echo.Response
}

var EchoResult_Success_DEFAULT *multi_echo.Response

func (p *EchoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(multi_echo.Response)
	}
...
func (p *EchoResult) GetSuccess() *multi_echo.Response {
	if !p.IsSetSuccess() {
...
func (p *EchoResult) SetSuccess(x interface{}) {
	p.Success = x.(*multi_echo.Response)
}
